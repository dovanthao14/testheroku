            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Đăng tài khoản <?=type_game($widget);?></h4>
                            </div>
                            <div class="content">                                
                            <form id="form_create" action="" enctype ="multipart/form-data" method="POST">
                            <input type="hidden" name="type_account" value="<?=$widget;?>">
                            <div class="row">
                             <div class="col-sm-4">
                            ...
                            <div class="row">
                             ...
                             <div class="col-sm-3">
                              <div class="form-group">
                               ...
                               <input type="number" class="form-control border-input" name="gem_count" placeholder="Số PET">
                              </div></div>
                             <div class="col-sm-3">
                              <div class="form-group">
