...
$id = GET('id');
$sql_products = "SELECT * FROM `products` WHERE `status` = '0' AND `id` = '{$id}'";
...
<form method="POST" id="buy_account">
                        ...
                        <li class="c-font-dark">
                            <table class="table table-striped">
                                ...
                                <tbody class="luauytin">
                                    <tr>
                                        <td>Tên game:</td>
                                        <th><?=type_game($products['type_account']);?></th>
                                    </tr>
                                    <tr>
                                        <td>Giá tiền:</td>
                                        <th class="text-danger"><?=number_format($products['price']);?>đ</th>
                                    </tr>
                                <?=is_client() ? 
                                    '<tr>
                                        <td>Số dư:</td>
                                        <th class="text-info">'.number_format($accounts['cash']).'đ</th>
                                    </tr>'
                                : ''?>
                                </tbody>
                            </table>
                        ...
                        <li class="c-font-dark">
                            <table class="table table-striped">
                                ...
                                <?php if($products['type_account'] == 'lien-quan'):?>
                                    <tr>
                                        <td style="width:50%">Số tướng:</td>
                                        <td class="text-info" style="font-weight: 700"><?=$products['champs_count'];?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">Số trang phục:</td>
                                        <td class="text-success" style="font-weight: 700"><?=$products['skins_count'];?></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%">Bậc ngọc:</td>
                                        <td class="text-warning" style="font-weight: 700"><?=$products['gem_count'];?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">Rank:</td>
                                        <td class="text-danger" style="font-weight: 700"><?=string_rank($products['rank']);?></td>
                                    </tr>
                                <?php else:?>
                                    <tr>
                                        <td style="width:50%">Số skin súng:</td>
                                        <td class="text-info" style="font-weight: 700"><?=$products['champs_count'];?></td>
                                    </tr>
                                    <tr>
                                        <td style="width:50%">Số trang phục:</td>
                                ...
                                <?php endif;?>
                                <?php if(!empty($products['note'])):?>
                                    <tr>
                                        <td style="width:50%">Note:</td>
                                        <td class="text-default" style="font-weight: 700"><?=$products['note'];?></td>
                                    </tr>
                                <?php endif;?>
                                </tbody>
                            </table>
    ...
    <?php else:?>
        <button id="purchase" type="submit" class="btn c-theme-btn c-btn-square c-btn-uppercase c-btn-bold" onclick="buy_account(<?=$products['id'];?>);">Thanh Toán</button>
    <?php endif;?>
